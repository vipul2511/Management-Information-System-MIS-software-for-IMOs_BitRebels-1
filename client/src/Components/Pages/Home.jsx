              ...
              <Row>
                <Col lg={6}>
                  ...
                  <p className="video_p">
                    ...
                    Organizations (IMOs) and Women Self Help Groups (SHGs) and
                    to augment their capacities through multi-pronged efforts.
                  </p>
                </Col>
                <Col>
                  <YouTube
            ...
            <ul class="social">
              <li class="fb">
                <a href="https://chat.whatsapp.com/Dr9dgZSkRkQ9vcm0HOrMXM">
                  <i class="fab fa-whatsapp" style={{ color: "white" }}>
                    <WhatsAppIcon style={{ height: "28px", width: "28px" }} />
                  </i>
                </a>
              </li>
            </ul>
              ...
              <Row>
                <Col className="AboutRMKUS">
                  ...
                  >
                    ...
                    under the Ministry of Women & Child Development. It was
